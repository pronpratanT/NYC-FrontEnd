...
interface PuValidatedModalProps {
    open: boolean;
    onClose: () => void;
...
const PuValidatedModal: React.FC<PuValidatedModalProps> = ({ open, onClose, onConfirm, poNo }) => {
            ...
            >
                ...
                <div className={`relative rounded-t-2xl p-6 text-white ${isDarkMode ? 'bg-gradient-to-r from-emerald-600 to-green-600' : 'bg-gradient-to-r from-emerald-500 to-green-500'}`}>
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-xl font-bold">ออก PO</h2>
                ...
                <div className={`p-6 rounded-b-2xl ${isDarkMode ? 'bg-slate-800' : 'bg-white'}`}>
                    <div className="mb-6">
                        <label className={`block mb-3 text-sm font-semibold ${isDarkMode ? 'text-slate-200' : 'text-gray-700'}`}>
                            เหตุผลในการออก PO<span className={`${isDarkMode ? 'text-emerald-400' : 'text-emerald-600'}`}>*</span>
                        </label>
                        <textarea
...
export default PuValidatedModal;
